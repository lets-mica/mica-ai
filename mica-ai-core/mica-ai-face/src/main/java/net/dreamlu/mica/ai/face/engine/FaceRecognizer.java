 ...
 * 具体对齐逻辑由 {@link net.dreamlu.mica.ai.face.preprocess.ImageUtils#align(BufferedImage, net.dreamlu.mica.ai.face.config.FaceBox, int)} 提供。
 *
 ...
 * @since 1.0.0
 */
public interface FaceRecognizer extends AutoCloseable {
